...
use crate::invoice::domain::{Service, format_code, next_bill_number, resolve_voucher_params};
...
pub async fn create_bill(
    ...
    for line_req in &body.lines {
        ...
        let service = repository::fetch_service(&state.db, line_req.service_id).await?;
    ...
    // 5. Acquire advisory lock + compute next bill number
