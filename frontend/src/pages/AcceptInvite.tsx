...
const SLACK_INVITE_URL = 'https://join.slack.com/t/coworkinmtp/shared_invite/zt-3zuwhmuxu-TqqZP9f4mMldt8sy4E_7pg'
          ...
          <div className="card-body gap-4">
            {created ? (
              <div className="flex flex-col gap-4">
                <h2 className="card-title text-base">Compte créé !</h2>
                <p className="text-sm text-base-content/70">
                  Votre compte a bien été créé. Vous pouvez maintenant vous connecter.
                </p>
                {SLACK_INVITE_URL && (
                  <div className="alert alert-info text-sm flex flex-col items-start gap-2">
                    <span>Rejoignez l'espace Slack, canal d'échange principal du coworking</span>
                    <a
